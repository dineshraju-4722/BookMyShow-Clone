...
export default function Navbar() {
   ...
   const [location,setLocation]=useState(false);
    ...
    return (
        <section className="w-[100%] h-[5rem] bg-[#FFFFFF] border-box px-[5vw] flex justify-between items-center border">
            ...
            <section className=" w-[14rem] flex items-center justify-between">
                <section className='flex items-center mb-[0]' onClick={()=>setLocation(true)}>
                    <span className='mr-[0.8rem] font-bold'>chitoor</span>
                    <span>
